...
public class VictoryInOneMoveFromLeftCorner {
    ...
    public Move execute(char[][] field, char playerToCheck) { //from left upper corner to right lower corner
        ...
        j = 0;
        if (countPlayerToCheck == 2 && countEmptyCells == 1) { // there is possibility to win in one move in diagonal from upper left corner
            for (int i = 0; i < field.length; i++) {
